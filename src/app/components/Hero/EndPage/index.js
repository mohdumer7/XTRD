...
const EndPage = () => {
  ...
  return (
    <section className="h-1/2 px-[2rem] md:px-44 items-center flex flex-col mb-20 gap-20 ">
      ...
      <div className="con-2 text-2xl flex flex-col w-[67%] justify-center items-center ">
        <button
          ...
          className="sub-button-2 flex items-center  justify-between p-4 w-full md:w-3/4 h-12"
        >
